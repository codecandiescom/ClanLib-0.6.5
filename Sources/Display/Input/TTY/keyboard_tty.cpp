/*
	$Id: keyboard_tty.cpp,v 1.7 2002/01/23 11:47:54 sphair Exp $
...
void CL_TTYKeyboard::keep_alive()
{
	int readlen;
...
void CL_TTYKeyboard::handle_code(char code)
{
	...
	if (keydown) CL_Input::sig_button_press()(this, key);
	else CL_Input::sig_button_release()(this, key);
...
char *CL_TTYKeyboard::get_name() const
{
	return "TTY keyboard";
}

CL_InputDevice::InputDeviceType CL_TTYKeyboard::get_type() const
{
	return CL_InputDevice::type_keyboard;
}

int CL_TTYKeyboard::get_num_buttons() const
{
	return CL_NUM_KEYS;
}

CL_InputButton *CL_TTYKeyboard::get_button(int button_num)
{
	if (buttons[button_num] != NULL) return buttons[button_num];
	
	buttons[button_num] =
		new CL_InputButton_TTYKeyboard(button_num, keymap);	

	return buttons[button_num];
}

int CL_TTYKeyboard::get_num_axes() const
{
	return 0;
}

CL_InputAxis *CL_TTYKeyboard::get_axis(int /*axis_num*/)
{
	return NULL;
}

int CL_TTYKeyboard::get_num_hats() const
{
	return 0;
}

CL_InputHat *CL_TTYKeyboard::get_hat(int /*hat_num*/)
{
	return NULL;
}

int CL_TTYKeyboard::get_num_cursors() const
{
	return 0;
}

CL_InputCursor *CL_TTYKeyboard::get_cursor(int /*cursor_num*/)
{
	return NULL;
}

/***************************
  CL_InputButton_TTYKeyboard
***************************/

CL_InputButton_TTYKeyboard::CL_InputButton_TTYKeyboard(
...
bool CL_InputButton_TTYKeyboard::is_pressed()
{
	return keymap[key];
}
