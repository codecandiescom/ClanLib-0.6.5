/*
	$Id: target_ximage_shm.h,v 1.1 2001/03/06 15:09:17 mbn Exp $
...
#ifndef header_target_ximage_shm
#define header_target_ximage_shm
...
class CL_Target_XImage_Shm : public CL_Target_XImage
{
public:
	CL_Target_XImage_Shm(
		XVisualInfo visual_info,
		Display *dpy,
		unsigned int width,
		unsigned int height);
		
	virtual ~CL_Target_XImage_Shm();
