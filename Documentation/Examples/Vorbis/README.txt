       ...
       Status: Windows(Y), Linux(Y)
        Level: Intermediate
      Modules: app, core, sound, vorbis
Last modified: 16. october 2001
     Progress: Complete
   Maintainer: Core developers
      Summary: Ogg Vorbis music (free alternative to mp3), Sound filters
...
This example demonstrates the use of ClanVorbis to play .ogg files. The use
of SoundFilters is also demontrated. 
